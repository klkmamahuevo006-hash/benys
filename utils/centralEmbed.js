...
class CentralEmbedHandler {
    ...
    async createCentralEmbed(channelId, guildId) {
        try {
            ...
            .setAuthor({ name: '☾‘ Control Center', iconURL: 'https://cdn.discordapp.com/emojis/896724352949706762.gif', url: 'https://discord.gg/xQF9f9yUEM' })
                .setDescription([
                    '',
        ...
        try {
            ...
            if (trackInfo) {
                ...
                embed = new EmbedBuilder()
                    ...
                    .setColor(embedColor)
                    .setFooter({ 
                        text: `☾‘ • ${statusText} • Developed By Beny`,
                        iconURL: this.client.user.displayAvatarURL()
                    })
                    .setTimestamp();
